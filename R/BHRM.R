...
BHRM_temp = function(Y,t.values,seed.no=1,burn=2000,nmc=2000,thin=10, varrho = 0, pro.var.theta.2 = 0.0002, pro.var.theta.3 = 0.05, mu = 0, rho.sq = 1){
  # Calling packages
  {
    library(mvtnorm)
    library(truncdist)
...
#' res_noncov = BHRM(Y = Y, t.values = t.values, seed.no = seed.no, burn = burn,
...
BHRM = function(Y,t.values,seed.no=1,burn=2000,nmc=2000,thin=10, varrho = 0, pro.var.theta.2 = 0.0002, pro.var.theta.3 = 0.05, mu = 0, rho.sq = 1){
  library("compiler")
  BHRM = cmpfun(BHRM_temp)
  res = BHRM(Y,t.values,seed.no,burn,nmc,thin, varrho, pro.var.theta.2, pro.var.theta.3, mu, rho.sq)
  res
}
